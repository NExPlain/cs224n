...
def get_train_test_args():
    ...
    parser.add_argument('--train-datasets', type=str, default='race,duorc,relation_extraction')
    parser.add_argument('--run-name', type=str, default='multitask_distilbert')
    parser.add_argument('--recompute-features', action='store_true')
    parser.add_argument('--train-dir', type=str, default='datasets/oodomain_val')
    ...
    parser.add_argument('--freeze-layer', type=int, default=4) # max 6
